...
export default class Export extends React.Component {
    ...
    render() {
        return (
            <div>  
                <ButtonComponent cssClass='e-outline' style={{ width: "100%", padding:"0px", height:"auto" }} onClick={e => this.exportSelected("CADL")}>
                    <div style={{width: "100%"}}>
                        ...
                        <div style={{marginLeft: "150px"}}> 
                            <div>
                                <p className="wordwrap" style={{ marginLeft: "10px", fontSize: "15px", textAlign: "left" }}>
